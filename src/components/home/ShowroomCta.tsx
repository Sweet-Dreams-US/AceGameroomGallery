      ...
      <div className="max-w-[1600px] mx-auto px-6 lg:px-10">
        <div className="grid grid-cols-12 gap-6 lg:gap-12 items-center">
          ...
          >
            ...
            <h2 className="font-playfair text-4xl lg:text-6xl font-bold text-[#1a1612] leading-[1.05] mb-6">
            ...
            <div className="space-y-5 mb-10">
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-full bg-[#d4a843]/10 border border-[#d4a843]/30 flex items-center justify-center flex-shrink-0">
                  <MapPin className="w-4 h-4 text-[#b8933a]" />
                </div>
                <div>
                  <p className="text-xs eyebrow mb-1">Location</p>
                  <p className="text-[#1a1612]">2525 W Jefferson Blvd</p>
                  <p className="text-sm text-[#6b655e]">Fort Wayne, IN 46802</p>
                </div>
              </div>

              <div className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-full bg-[#d4a843]/10 border border-[#d4a843]/30 flex items-center justify-center flex-shrink-0">
                  <Clock className="w-4 h-4 text-[#b8933a]" />
                </div>
                <div>
                  <p className="text-xs eyebrow mb-1">Hours</p>
                  <p className="text-[#1a1612]">Monday — Saturday</p>
                  <p className="text-sm text-[#6b655e]">10:00 AM — 6:00 PM · Sunday Closed</p>
                </div>
              </div>

              <div className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-full bg-[#d4a843]/10 border border-[#d4a843]/30 flex items-center justify-center flex-shrink-0">
                  <Phone className="w-4 h-4 text-[#b8933a]" />
                </div>
                <div>
                  <p className="text-xs eyebrow mb-1">Call</p>
                  <a
                    href="tel:+12604323443"
                    className="text-[#1a1612] hover:text-[#b8933a] transition-colors"
                  >
                    (260) 432-3443
                  </a>
                  <p className="text-sm text-[#6b655e]">Ask for Bret.</p>
                </div>
              </div>
            </div>
